package com.br.cobranca.controller;
...
import com.br.cobranca.service.CadastroTituloService;
...
public class TituloController {
	...
	public ModelAndView pesquisaTitulos(@ModelAttribute("filtro")TituloFilter filtro) {
		List<Titulo> pesquisaTitulos = cadastroTituloService.filtrar(filtro);
		ModelAndView mv = new ModelAndView("PesquisaTitulos");
		mv.addObject("titulos",pesquisaTitulos);
		return mv;
	}
	...
	public String exlcuir(@PathVariable("codigo")Long codigo, RedirectAttributes attributes) {
		cadastroTituloService.exlcuir(codigo);
